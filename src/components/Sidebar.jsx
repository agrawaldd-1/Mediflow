...
import { FaChevronDown, FaChevronRight, FaHospital, FaSignOutAlt } from "react-icons/fa";
...
const Sidebar = () => {
    ...
    return (
        <aside className="flex min-h-0 h-full w-72 flex-col border-r border-gray-200 bg-white">
