...
const UpdateReceptionistProfile = () => {
    ...
    useEffect(() => {
        const fetchReceptionist = async () => {
            try {
                const response = await getReceptionistById(
                    receptionistId
                );
...
export default UpdateReceptionistProfile;